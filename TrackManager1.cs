...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager1 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager1(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/B");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg1rep1");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayB");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportb");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            obstacleRect = new Rectangle(700, 40, obstacle.Width, obstacle.Height);
            ...
            mdg11Rect = new Rectangle(40, 90, 50, 50);
            if (power2)
                mdg12Rect = new Rectangle(2000, 2000, 50, 50);
            else
            mdg12Rect = new Rectangle(50, 230, 50, 50);
            if (power3)
            ...
            mdg14Rect = new Rectangle(300, 430, 50, 50);
            if (power5)
                mdg15Rect = new Rectangle(2000, 2000, 50, 50);
            else
            mdg15Rect = new Rectangle(400, 70, 50, 50);
            if (power6)
                mdg8Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg8Rect = new Rectangle(350, 380, 50, 50);
            if (power7)
                mdg81Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg81Rect = new Rectangle(50, 230, 50, 50);
            if (carPosition.X >= 700)
                isOver = true;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(350, 380), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(50, 230), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power1)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(40, 90, 50, 50), Color.White);
            ...
            if (power4)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(300, 430, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(350, 380, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(50, 230, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
            spriteList.Add(
               new ChasingSprite(Game.Content.Load<Texture2D>(@"Images\anger"),
               position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
               new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite(Game.Content.Load<Texture2D>(@"Images\hunger"),
