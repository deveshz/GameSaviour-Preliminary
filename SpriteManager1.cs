...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager1 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager1(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            //---------------------------------------------------------
            saviour = new
SaviourBrick(Game.Content.Load<Texture2D>(@"Images/saviour"), new
Vector2(550, 300), 0, new Point(50, 50), new Point(0, 0), new Point(4, 1), 0);
            //----------------------------------------------------------------------
...
0), new Point(1, 1)));
 ...
 0), new Point(1, 1)));
            ...
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(600, 450), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
          Game.Content.Load<Texture2D>(@"Images/brick"),
...
0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(650, 250), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
 ...
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
           Game.Content.Load<Texture2D>(@"Images/brick"),
           new Vector2(650, 450), 0, new Point(50, 50), new Point(0,
0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
 ...
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(700, 250), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(700, 300), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
...
0), new Point(1, 1)));
 ...
 0), new Point(1, 1)));
            ...
            //-----------------------------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg1"),
             new Vector2(450, 450), 0, new Point(50, 50), new
...
0), new Point(1, 1));
            goal5 = new GoalBrick(
        Game.Content.Load<Texture2D>(@"Images/mdg1"),
        new Vector2(650, 350), 0, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            goal6 = new GoalBrick(
        Game.Content.Load<Texture2D>(@"Images/mdg1"),
        new Vector2(600, 250), 0, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/angrybox"),
         new Vector2(500, 150), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/angrybox"),
            new Vector2(550, 150), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/angrybox"),
                new Vector2(600, 150), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/angrybox"),
            new Vector2(650, 150), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/angrybox"),
           new Vector2(550, 200), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest6 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/angrybox"),
          new Vector2(600, 200), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            final5 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg1");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\back");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances > 0)
                loose = false;
            else if (((Game1)Game).chances <= 0 && steps == -1)
                loose = true;
            ...
            retryRect = new Rectangle(100, 150, 250, 150);
            ...
            if (goal1.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal1.position.X <= 400)
                    goal1.position.X = 400;
            ...
            if (goal1.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (goal1.position.Y >= 500)
                    goal1.position.Y = 500;
            ...
            if (goal5.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal5.position.X <= 400)
                    goal5.position.X = 400;
            ...
            if (goal5.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal5.position.Y >= 500)
                    goal5.position.Y = 500;
            ...
            if (goal2.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal2.position.X <= 400)
                    goal2.position.X = 400;
            ...
            if (goal2.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal2.position.Y >= 500)
                    goal2.position.Y = 500;
            ...
            if (goal3.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal3.position.X <= 400)
                    goal3.position.X = 400;
            ...
            if (goal3.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal3.position.Y >= 500)
                    goal3.position.Y = 500;
            ...
            if (goal4.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal4.position.X <= 400)
                    goal4.position.X = 400;
            ...
            if (goal4.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal4.position.Y >= 500)
                    goal4.position.Y = 500;
            ...
            if (goal6.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                if (saviour.position.X <= 450)
                    saviour.position.X = 450;
                if (goal6.position.X <= 400)
                    goal6.position.X = 400;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(grid, new Vector2(400, 150), Color.White);
            foreach (Brick s in spriteList)
            ...
            if (a && b && c && d && e && f)
            {
                spriteBatch.Draw(win, new Vector2(300, 80), Color.White);
            ...
            if (((Game1)Game).chances > 0)
            {
                spriteBatch.Draw(mdg8, new Vector2(100, 400), Color.White);
            }
            else if (((Game1)Game).chances <= 0)
            {
                spriteBatch.Draw(lifeno, new Vector2(100, 400), Color.White);
            }
