...
Vector2(450, 400), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //----------------------------------------------------------------------
...
0), new Point(1, 1)));
 ...
 0), new Point(1, 1)));
            ...
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(550, 400), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
 ...
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(600, 400), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
 ...
 0), new Point(1, 1)));
            ...
            goal1 = new GoalBrick(
             ...
             new Vector2(450, 300), 0, new Point(50, 50), new
...
0), new Point(1, 1));
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/hungrybox"),
         new Vector2(450, 250), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/hungrybox"),
            new Vector2(500, 300), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/hungrybox"),
                new Vector2(500, 250), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/hungrybox"),
            new Vector2(500, 200), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/hungrybox"),
           new Vector2(550, 250), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            //--------------------------------------------------
...
Vector2(450, 400), 0, new Point(50, 50), new Point(0, 0), new Point(4, 1), 0);
                goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg1"),
             new Vector2(450, 300), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
